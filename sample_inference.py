...
rgb = np.array(Image.open('/home/hanat/workspace/dataset/depth_completion/color/51.png'), dtype = np.float32)
depth = np.array(Image.open('/home/hanat/workspace/dataset/depth_completion/depth/51.png'), dtype = np.float32)
depth_gt = np.array(Image.open('/home/hanat/workspace/dataset/depth_completion/depth/51.png'), dtype = np.float32)
