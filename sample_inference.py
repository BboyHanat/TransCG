...
def draw_point_cloud(color, depth, camera_intrinsics, use_mask=False, use_inpainting=True, scale=1000.0,
                     inpainting_radius=5, fault_depth_limit=0.2, epsilon=0.01):
    """
...
rgb = np.array(Image.open('/home/hanat/workspace/dataset/depth_completion_cup/color/86.png'), dtype=np.float32)
depth = np.array(Image.open('/home/hanat/workspace/dataset/depth_completion_cup/depth/86.png'), dtype=np.float32)
depth_gt = np.array(Image.open('/home/hanat/workspace/dataset/depth_completion_cup/depth/86.png'), dtype=np.float32)
